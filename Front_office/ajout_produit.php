...
if (isset($_POST['ajouter'])) {
    ...
    $req = $pdo->prepare('INSERT INTO produit (Nom_produit, prix, description, stock, code_barre, image)
                          VALUES (:nom, :prix, :description, :stock, :code_barre, 0)');
        ...
        <form method="POST" enctype="multipart/form-data" style="display: contents;">
            ...
            <div class="detail-gauche">
                ...
                <div class="codebarre-section">
                    <p class="codebarre-label">Code-barres</p>

                    <!-- CHAMPS MANQUANTS -->
                    <input type="text" id="barcodeValue" name="code_barre" placeholder="Code barre">
                    

                    <div id="statusBox" class="status">Initialisation de DYMO…</div>

                    <div class="codebarre-zone" id="previewZone">
                        <div class="muted">Aucun aperçu généré.</div>
                    </div>

                    <div class="field">
                        <label class="codebarre-label">Nombre d’exemplaires</label>
                ...
                <div class="field">
                    <label class="codebarre-label">Imprimante DYMO</label>
                    <select id="printerSelect"></select>
                </div>
                <input type="text" id="productName" name="nom" placeholder="Nom produit">
                    <input type="number" id="priceValue" name="prix" placeholder="Prix">
                ...
                <!-- BOUTON SUBMIT -->
                <button class="btn-enregistrer" type="submit" name="ajouter">Enregistrer</button>
            ...
            <div class="form-right">
                ...
                <div class="detail-image-zone" id="detail-image-zone-img">
...
function previewImage(e) {
  ...
  r.onload = ev => {
    ...
    const box = document.getElementById('detail-image-zone img');
    img.src = ev.target.result;
    img.style.display = 'block';
    if (box) box.classList.remove('detail-image-zone img--empty');
